...
<div class="card mb-3 company" >
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="https://mdbootstrap.com/img/Photos/Vertical/mountain1.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body company-desc">
        <h1 class="display-1">Έπιπλο Τσομπάνης</h1>
